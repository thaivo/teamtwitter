...
var envinfo = {"qx.application":"teamtwitter.Application","qx.revision":"","qx.theme":"teamtwitter.theme.Theme","qx.version":"5.0.2"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qx":{"resourceUri":"../qooxdoo-5.0.2-sdk/framework/source/resource","sourceUri":"../qooxdoo-5.0.2-sdk/framework/source/class","sourceViewUri":"https://github.com/qooxdoo/qooxdoo/blob/%{qxGitBranch}/framework/source/class/%{classFilePath}#L%{lineNumber}"},"teamtwitter":{"resourceUri":"../source/resource","sourceUri":"../source/class"}};
